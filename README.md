...
----------------
 - you are reading readme for Crude Oilz (ticker CLz)
 - coin unit: Barrelz of Crude Oilz
 - underlying commodity: Crude Oil in USD (future contract year+1 March ending)
 - price on 2013 Nov. 12: USD 94 per barrel
 - underlying commodity price: http://finance.yahoo.com/webservice/v1/symbols/CLH15.NYM/quote?format=json
