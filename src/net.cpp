...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CLz " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"a.bitcommoditiz.org", "clz.bitcommoditiz.org"},
    {"b.bitcommoditiz.org", "clz.bitcommoditiz.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"a.bitcommoditiz.org", "testnet.clz.bitcommoditiz.org"},
    {"b.bitcommoditiz.org", "testnet.clz.bitcommoditiz.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CLz is probably already running."), addrBind.ToString().c_str());
        else
